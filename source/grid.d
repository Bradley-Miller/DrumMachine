...
class WorkSpace : Box{
	...
	this(){
		...
		//Row 0: Bass Drum
		for(int i = 0; i<10; i++){
			Switch bassSwitch = new BassSwitch(i);
		...
		//Row 1: Snare Drum
		for(int i = 0; i<10; i++){
			Switch snareSwitch = new SnareSwitch(i);
		...
		//Row 2: Hi-Hats
		for(int i = 0; i<10; i++){
			Switch hiHatSwitch = new HiHatSwitch(i);
		...
		//Row 3: Tom-Toms
		for(int i = 0; i<10; i++){
			Switch tomTomSwitch = new TomTomSwitch(i);
		...
		//Row 4: Crash-Cymbol
		for(int i = 0; i<10; i++){
			Switch crashSwitch = new CrashSwitch(i);
		...
		//Row 5: Ride-Cymbol
		for(int i = 0; i<10; i++){
			Switch rideSwitch = new RideSwitch(i);
		...
		//row 6: Skip
		for(int i = 0; i<10; i++){
			Switch skipSwitch = new SkipSwitch(i);
